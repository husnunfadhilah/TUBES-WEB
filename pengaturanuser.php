...
session_start();
$currentUsername = isset($_SESSION['username']) ? $_SESSION['username'] : 'users'; // Ganti dengan data dari database
?>
...
<body>
    ...
    <div class="content">
        <div class="box">
            ...
            <form action="updateprofiluser.php" method="POST" enctype="multipart/form-data">
